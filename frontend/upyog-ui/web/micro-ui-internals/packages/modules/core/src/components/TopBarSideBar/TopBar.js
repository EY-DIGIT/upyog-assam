...
const TopBar = ({
  ...
  return (
    <div className="topbar">
      ...
      <img className="city" src="https://assamey-filestore.s3.ap-south-1.amazonaws.com/assets/govt_assam_logo.png" />
      <span style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
        ...
        {!mobileView && (
          <div className={mobileView ? "right" : "flex-right right w-80 column-gap-15"} style={!loggedin ? { width: "80%" } : {}}>
            ...
            <img className="state" src="https://assamey-filestore.s3.ap-south-1.amazonaws.com/assets/govt_assam_logo.png" />
          </div>
        )}
      </span>
    </div>
