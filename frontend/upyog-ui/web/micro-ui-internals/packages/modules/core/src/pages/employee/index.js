    ...
    <div className="employee">
      <Switch>
        <Route path={`${path}/user`}>
          ...
          >
            <div className="loginnn">
              ...
              <picture>
                <source id="backgroung-login" media="(min-width: 950px)" srcset="https://assamey-filestore.s3.ap-south-1.amazonaws.com/assets/eyeem-100732797.jpg" style={{"position":"absolute","height":"100%","width":"100%"}} />
                  <source media="(min-width: 250px)" srcset="https://nugp-assets.s3.ap-south-1.amazonaws.com/nugp+asset/Banner+UPYOG+%28500x900%29.jpg" />
                    <img src="https://assamey-filestore.s3.ap-south-1.amazonaws.com/assets/eyeem-100732797.jpg" alt="imagealttext" style={{"position":"absolute","height":"100%","width":"100%","zIndex":"1","display":window.location.href.includes("user/profile")?"none":""}}/>
                    </picture>
          ...
          <div className={`main ${DSO ? "m-auto" : ""}`}>
            ...
            {/* <div className="footerr" style={{ width: '100%', bottom: 0,backgroundColor:"white",color:"black !important"}}>
              <div style={{ display: 'flex', justifyContent: 'center', color:"color","backgroundColor":"#808080b3"  }}>
                ...
                <span style={{ margin: "0 10px" }}>|</span>
                <a style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} href={pdfUrl} target='_blank'>Assam License</a>
              </div>
            </div> */}
        ...
        <div style={{ display: 'flex', justifyContent: 'center', color:"black" }}>
          ...
          <a style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile()?"12px":"14px", fontWeight: "400"}} href="#" target='_blank'>Assam License</a>
          ...
          {/* <a style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} href="#" target='_blank'>Assam License</a> */}
        </div>
